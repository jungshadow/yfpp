    ...
    return (
        <div className="userContent userContent_reversed">
            ...
            <p>
                ...
                browser), web beacons, or unique device identifiers to
                anonymously identify your computer or device so we can deliver a
                better experience. Our systems also log information like your
                browser, operating system and IP address.
            </p>
            <p>
                We do not collect personally identifiable information about you.
                In other words, we do not collect information such as your name,
            ...
            <p>
                Lookups are done by submitting your address directly to Google
                via the{' '}
                ...
                . As part of this request some additional information about you,
                such as the browser you use, the domain name you&apos;re
                submitting your address via (this one) and your IP address are
                attached. How Google treats user data is governed by the{' '}
            ...
            <p>
                We do not allow advertising companies to collect data through
                our service for ad targeting.
            </p>
            ...
            <p>
                ...
                used. They use this data solely on our behalf. They do not share
                it except in aggregate form; no data is shared as to any
                individual user. Click to see company privacy policies that
            ...
            <p>
                ...
                limited circumstances: (1) with your express consent, (2) when
                we have a good faith belief it is required by law, (3) when we
                have a good faith belief it is necessary to protect our rights
                or property, or (4) to any successor or purchaser in a merger,
                acquisition, liquidation, dissolution or sale of assets. Your
                consent will not be required for disclosure in these cases, but
                we will attempt to notify you, to the extent permitted by law to
                do so.
            </p>
            <h3>You can review more privacy-related information.</h3>
            <p>
                This privacy policy was last updated on Nov 2, 2014. Our privacy
