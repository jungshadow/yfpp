...
window.twttr.ready(function(twttr) {
    //Wrap on twttr.ready for async compatibility.
    /*
        Twitter Tracking
...
$(function() {
    $('#app').on('click', '.shareLocationFacebook', function(event) {
        ...
        var obj = {
            ...
            description:
                'I vote at ' + $(this).data('name') + ' in ' + $(this).data('city') + ' ' + $(this).data('state') + ', where the fuck do you vote? Visit YourFuckingPollingPlace.com to find out.',
        };
...
class Actions extends React.Component {
    ...
    buildTweet() {
        ...
        const authorTwitter = helpers.shuffle(['golovashkina', 'joshualturner', 'jungshadow', 'momaraqa', 'nickcatal', 'sixBcreative']);
        ...
        return (
            <a className="actionLink actionLink_twitter" href={'https://twitter.com/intent/tweet?text=' + text + '&url=' + url + '&related=' + related + '&via=fnpollingplace'}>
                Tweet
            </a>
        );
    }
        ...
        return (
            <ul className="actions">
                ...
                <li className="actions-item">
                    ...
                    <div className="actions-item-links">{this.buildMap()}</div>
                </li>
            </ul>
        );
    }
