                                ...
                                <li>
                                    <a href={bioData.linkedIn} className="iconLink">
                                        <span className="iconLink-icon">
                                            <i className="icon icon_linkedin mix-icon_sm" />
                                        </span>
                    ...
                    <div className="bio-bd">
                        <div className="group group_md">
                            <div className="group-hd">
                                <h4 className="hdg hdg_2 mix-hdg_headline mix-hdg_uppercase mix-hdg_light">
                                    {bioData.firstname} {bioData.nickname ? <span className="txt txt_headline mix-txt_lgtBlue">{'"' + bioData.nickname + '"'}</span> : ''} {bioData.lastname}
                                </h4>
