                        ...
                        <ul className="blocks blocks_2upSM blocks_4upMD blocks_6up js-carouselNav">
                            ...
                            <li>
                                <div className="group group_sm">
                                    ...
                                    <div>
                                        <a className="mix-a_reversed mix-txt_medium twitter-follow-button" target="_blank" rel="noopener noreferrer"
                                            href="https://twitter.com/jungshadow" data-show-count="false">@jungshadow</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="group group_sm">
                                    <div>
                                        <a href="#jay" className="txtBtn js-carouselNav-link" onClick={this.props.onModalClickHandler.bind(this)}>
                                            <div className="group group_md">
                                                <div className="group-img"> <img className="imgSize imgSize_sm" src="web/images/bios/jay-johnson.jpg" alt="Jay Johnson"
                                                    /> </div>
                                    ...
                                    <div>
                                        <a className="mix-a_reversed mix-txt_medium twitter-follow-button" target="_blank" rel="noopener noreferrer"
                                            href="https://twitter.com/sixbcreative" data-show-count="false">@sixbcreative</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="group group_sm">
                                    <div>
                                        <a href="#nick" className="txtBtn js-carouselNav-link" onClick={this.props.onModalClickHandler.bind(this)}>
                                            <div className="group group_md">
                                                <div className="group-img"> <img className="imgSize imgSize_sm" src="web/images/bios/nick-catalano.jpg" alt="Nick Catalano"
                                                    /> </div>
                                    ...
                                    <div>
                                        <a className="mix-a_reversed mix-txt_medium twitter-follow-button" target="_blank" rel="noopener noreferrer"
                                            href="https://twitter.com/NickCatal" data-show-count="false">@NickCatal</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="group group_sm">
                                    <div>
                                        <a href="#anastasia" className="txtBtn js-carouselNav-link" onClick={this.props.onModalClickHandler.bind(this)}>
                                            <div className="group group_md">
                                                <div className="group-img"> <img className="imgSize imgSize_sm" src="web/images/bios/anastasia-golovashkina.jpg"
                                                        alt="Anastasia Golovashkina" /> </div>
                                    ...
                                    <div>
                                        <a className="mix-a_reversed mix-txt_medium twitter-follow-button" target="_blank" rel="noopener noreferrer"
                                            href="https://twitter.com/golovashkina" data-show-count="false">@golovashkina</a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="group group_sm">
                                    <div>
                                        <a href="#josh" className="txtBtn js-carouselNav-link" onClick={this.props.onModalClickHandler.bind(this)}>
                                            <div className="group group_md">
                                                <div className="group-img"> <img className="imgSize imgSize_sm" src="web/images/bios/josh-turner.jpg" alt="Josh Turner"
                                                    /> </div>
                                    ...
                                    <div>
                                        <a className="mix-a_reversed mix-txt_medium twitter-follow-button" target="_blank" rel="noopener noreferrer"
                                            href="https://twitter.com/joshualturner" data-show-count="false">@joshualturner</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                    </div> <i className="icon icon_star-full mix-icon_centered mix-icon_hr"></i>
                    <div className="group mix-group_wide">
                        <section className="group-hd mix-group_txtCtr">
                            <div className="fb-shit">
                                <div className="fb-like" data-href="http://yourfuckingpollingplace.com/" data-send="false" data-layout="box_count"
                                    data-width="50" data-show-faces="true" data-colorscheme="light"> </div>
                            </div>
                        </section>
                        <section className="group-bd">
                            <div className="userContent userContent_reversedSofter mix-userContent_md mix-userContent_ctr">
                                ...
                                <p>Election officials sometimes revise data in the last few days before an election. Check back on Election
                                    Day for the latest information.</p>
                            </div>
                        </section>
                    </div>
                </div>
