                ...
                <div className="card">
                    <div className="card-bd">
                        <div className="card-hd">
                            <h2 className="hdg hdg_2 mix-hdg_capitalize mix-hdg_red mix-hdg_headline">Election Day Polling Place <small className="mix-hdg_dark">{moment(electionDay).format('MMMM Do')}</small></h2>
                        </div>
